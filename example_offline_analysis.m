...
[data,devents,hdr,allevents]=sliceraw('U:\IBCI\raw_buffer\0001','startSet',{'attention'},'trlen_ms',1500);
[data2,devents2,hdr2,allevents2]=sliceraw('U:\IBCI\wouter\150106\1540_1\raw_buffer\0001','startSet',{'attention'},'trlen_ms',1500);
[data3,devents3,hdr3,allevents3]=sliceraw('U:\IBCI\wouter-vervolg2\150106\1634_1\raw_buffer\0001','startSet',{'attention'},'trlen_ms',1500);

data = [data; data2; data3];
devents = [devents; devents2; devents3];
hdr = [hdr; hdr2; hdr3];
allevents = [allevents; allevents2; allevents3];
...
capFile='cap_tmsi_mobita_black'; % you should change this to represent whatever cap layout was used in your experiment
[clsfr,res,X,Y]=buffer_train_ersp_clsfr(data,devents,hdr,'freqband',[2 8 12 15],'capFile',capFile,'overridechnms',1,'width_ms',500);
